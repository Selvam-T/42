...
typedef struct s_program
{
	...
	int		dead; //if any ph died, set this to 1
...
//philo_message
void	print_status(t_program *sim, long t, int x, char *msg);
void	print_status2(t_program *sim, long t, int x, char *msg, int temp);
